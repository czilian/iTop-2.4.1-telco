...
EOF
		...
		$oPage->add('<table>');
		$oPage->add('<tr>');
		$oPage->add('<td><a href="http://www.volksbahn.biz" title="www.volksbahn.biz" target="_blank" style="background: none;"><img src="../images/itop-logo.png?itopversion='.ITOP_VERSION.'" style="float: right;"/></a></td>');
