...
EOF;
			...
			$sHtml .= ' <div id="top-left"></div><div id="logo"><a href="'.htmlentities($sIconUrl, ENT_QUOTES, 'UTF-8').'"><img src="'.$sDisplayIcon.'" title="'.htmlentities($sVersionString, ENT_QUOTES, 'UTF-8').'" style="border:0; margin-top:6px; margin-right:0px;"/></a></div>';
			$sHtml .= ' </div>';
			...
			$sHtml .= ' </div> <!-- /menu -->';
			$sHtml .= ' <div class="footer ui-layout-south"><div id="combodo_logo"><a href="http://www.volksbahn.biz" title="www.volksbahn.biz" target="_blank"><img src="../images/iTop-icon.ico?itopversion='.ITOP_VERSION.'"/></a></div></div>';
